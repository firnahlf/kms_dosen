...
$user = $_SESSION['username'];
    ...
    $query = mysqli_query($koneksi, "INSERT INTO forum_diskusi (judul_diskusi, isi_diskusi,tgl_pembuatan, user)
    VALUES('$judul_diskusi', '$isi_diskusi','$tgl_pembuatan', '$user')");

    if($query)
    {
        ?>
            <script language="javascript">
              alert("Diskusi baru berhasil disimpan!");
...

    {
        ?>
            <script language="javascript">
              ...
              document.location.href="add_forum_diskusi.php";
            </script>
        <?php
    }
}
