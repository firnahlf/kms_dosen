            ...
            <div class="col-md-10">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="myLargeModalLabel">Kirim Pesan</h5>
                </div>
                <div class="modal-body" >


                  <form enctype="multipart/form-data" action="proses_pesan.php" method="post" >
                    <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Kepada</label>
                       ...
                       include "../../include/config.php";
                        $sql_user = mysqli_query($koneksi, "SELECT * FROM users ORDER BY nama_lengkap ASC") or die(mysqli_error($koneksi));
                        while($data_user = mysqli_fetch_array($sql_user)){
                            echo '<option value="'.$data_user['nama_lengkap'].'"> '.$data_user['nama_lengkap'].' </option>';
                        }
                        ?>
                    </select>
                    </div>
