                ...
                <div class="modal-body" >
                  ...
                  <form enctype="multipart/form-data" action="proses_edit_user.php" method="post" >
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="id_user" name="id_user" value="<?php echo $tampil['id_user'] ;?>">
                    </div>
                    
                    <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Nama Lengkap</label>
                      <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?php echo $tampil['nama_lengkap'] ;?>">
                    </div>
                    ...
                    <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Jenis Kelamin</label><br>
                       <select class="form-control" name="jenis_kelamin" id="jenis_kelamin" required>
                        ...
                        <option value="Pria" <?php if($tampil['jenis_kelamin'] == 'Pria'){ echo "selected";} ?>>Pria</option>
                        <option value="Wanita" <?php if($tampil['jenis_kelamin'] == 'Wanita'){ echo "selected";} ?>>Wanita</option>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="alamat" name="alamat"value="<?php echo $tampil['alamat'] ;?>">
                    </div>
                    
                     <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Nomor Handphone</label>
                      <input type="number" class="form-control" id="no_hp" name="no_hp"value="<?php echo $tampil['no_hp'] ;?>">
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="password" name="password"value="<?php echo $tampil['password'] ;?>">
                    </div>
                    <div class="form-group">
